<div class="modal fade" id="revocar_permiso" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">           
      <form action="{{ url('revocar_permiso') }}" method="POST" >
        @csrf
        <div class="modal-body">          
          <h5 class="modal-title">Revocar permiso</h5>
          <hr>
          <div class="row">
            <div class="col-md-12">
              <label><strong>Rol: <output class="headertekst" type="text"  name="nombre" id="nombre"></strong></label>
              <input type="hidden" name="id" id="id" value="">  
              <select class="form-control" name="permiso"  id="select_revocar_permiso"required></select>
              <p></p>
            </div>
          </div>
        </div>
