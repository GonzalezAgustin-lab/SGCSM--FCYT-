...
<div class="form-group col-md-12">
  <div class="row">
    <div class="col-md-6">
      ...
      <input type="text" name="nombre" class="form-control" id="nombre" autocomplete="off" minlength="3" maxlength="30" required>
    </div>
    <div class="col-md-6">
      <label for="apellido"><strong>Apellido:</strong></label>
      <input type="text" name="apellido" class="form-control" id="apellido" autocomplete="off" minlength="3" maxlength="30" required>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <input type="number" name="dni" class="form-control" id="dni" autocomplete="off" minlength="8" maxlength="11" required>
    </div>
    <div class="col-md-6">
      <label for="interno"><strong>Interno:</strong></label>
      <input type="number" name="interno" class="form-control" id="interno" autocomplete="off" minlength="2" maxlength="5">
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <input type="date" name="fe_nac" id="fe_nac" class="form-control" step="1">
    </div>
    <div class="col-md-6">
